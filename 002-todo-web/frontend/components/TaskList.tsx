...
export default function TaskList({ tasks, onTaskUpdated, onTaskDeleted, emptyMessage }: TaskListProps) {
  if (!tasks || tasks.length === 0) {
    return (
      <div className="py-20 text-center">
        ...
        <p className="text-gray-400 font-medium">{emptyMessage || "No tasks yet. Start by adding one above!"}</p>
      </div>
    );
  }
