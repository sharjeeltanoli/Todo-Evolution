...
- [ ] **Phase V: Part A - Advanced Features Principles**:
  - [ ] Automation: RFC 5545 recurrence, completion-triggered generation, historical integrity.
  - [ ] Time-Sensitive: UTC storage, proactive notifications, visual urgency.
  - [ ] Organizational: Priority hierarchy, flexible tagging, alphanumeric/hyphenated sanitization.
  - [ ] Retrieval: Indexed full-text search, additive filtering (AND), predictable sorting.
- [ ] **Phase V: Part C - Cloud Deployment Principles**:
  - [ ] Managed Infrastructure: DOKS for cluster, Redpanda Cloud for Kafka, Neon for DB.
  - [ ] Production Security: All secrets in K8s Secrets, RBAC enforced, no secrets in VC.
  - [ ] Automation: GitHub Actions CI/CD for all services, immutable image tags (SHA).
  - [ ] Resilience: Multiple replicas (2+), health checks (liveness/readiness), managed backups.
- [ ] **Error Handling**:
